          ...
          <section id="forms">
            ...
            <article className="my-3" id="disabled-forms">
              <div className="bd-heading sticky-xl-top align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2">
                ...
                <a
                  className="d-flex align-items-center"
                  href="/docs/5.1/forms/overview/#disabled-forms"
                >
                  Documentation
                </a>
              </div>
            ...
            <article className="my-3" id="sizing">
              <div className="bd-heading sticky-xl-top align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2">
                ...
                <a
                  className="d-flex align-items-center"
                  href="/docs/5.1/forms/form-control/#sizing"
                >
                  Documentation
                </a>
              </div>
            ...
            <article className="my-3" id="input-group">
              <div className="bd-heading sticky-xl-top align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2">
                ...
                <a
                  className="d-flex align-items-center"
                  href="/docs/5.1/forms/input-group/"
                >
                  Documentation
                </a>
              </div>
            ...
            <article className="my-3" id="floating-labels">
              <div className="bd-heading sticky-xl-top align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2">
                ...
                <a
                  className="d-flex align-items-center"
                  href="/docs/5.1/forms/floating-labels/"
                >
                  Documentation
                </a>
              </div>
            ...
            <article className="my-3" id="validation">
              <div className="bd-heading sticky-xl-top align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2">
                ...
                <a
                  className="d-flex align-items-center"
                  href="/docs/5.1/forms/validation/"
                >
                  Documentation
                </a>
              </div>
